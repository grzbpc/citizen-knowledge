...
title: The policy didn't change. The optics did.
date: 2026-07-24
order: 1
...
> *Penalties are applied not to uphold principles but to signal that authority still has reach. Highly visible punishment compensates for widespread tolerance elsewhere. The message is not that the rule matters, but that surveillance is intermittent.*
> <span class="cite">The Performance of Obedience, Ch. 1</span>
