---
layout: post.njk
title: Water firms call it fairer pricing. It is a bill rise with a friendlier name.
date: 2026-08-17
order: 1
...
description: "Water companies including Thames Water are pushing plans, backed by government officials, to introduce 'surge pricing' that would charge households more for 'standard' and 'premium' water use such as hoses and sprinklers during droughts, with the changes described as making bills 'fairer and more affordable' while requiring universal smart meter rollout."
book_reference: "This entry treats the government's description of surge pricing as making bills 'fairer' while the underlying charge for the same water rises as an illustration of the manuscript's account of how rhetoric intensifies in direct proportion to how selectively a rule is actually applied."
...
The manuscript's account of selective rule enforcement describes exactly this kind of language: <blockquote class="quote--manuscript"><p>The more selectively a rule is applied, the more aggressively it must be defended rhetorically. Harsh penalties, moral language, and dramatic enforcement are used to compensate for the fact that the rule is not meant to be obeyed universally.</p><span class="cite">The Performance of Obedience, Ch. 2</span></blockquote>

Here the rhetoric is not harsh, it is the opposite: fairness, affordability, efficiency. But the function is the same. The softer the language around a change, the more worth asking what the change is actually doing. And what surge pricing actually does, on the numbers from its own pilot, is charge some customers 63 per cent more for water during exactly the weeks they are most likely to need it, while a separate class of customer, those already flagged as poor or vulnerable, is quietly excluded from the mechanism altogether.
